...
//Diplay list of all BookInstance
...
//Diplay detail page for a specific BookInstance
...
exports.bookinstance_create_post = function(req, res, next) {
  ...
  (res,req,next) => {
    ...
    // Createa a BookInstance object with escaped and trimmed data.
...
exports.bookinstance_update_get = function(req, res, next) {
    ...
    async.parallel({
      bookinstance: function (callback) {
        BookInstance.findById(req.param.id).populate('book').exec(callback);
      },
...
exports.bookinstance_update_post = [
    ...
    (req,res,next) => {
      const errors = validationResult(req);
        ...
        //Create a BookInstance object with escaped/trimmed data and curent id.
        var bookinstance = new BookInstance (
          {
            book: req.body.book,
            imprint: req.body.imprint,
          ...
          if (!errors.isEmpty()){
            // Errors in validation form, render the form again, passing sanitized values
            Book.find({},'title')
              .exec(function (err, books){
                if(err) { return next(err); }
                // Succesful, so render
